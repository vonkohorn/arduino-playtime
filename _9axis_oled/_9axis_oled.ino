...
//  Conflict.  OLED and 9-axis both use 0x3C on the I2C bus... so I'm stuck.  Not sure how to resolve.
//  Plus, the memory is stretched too thin to run on Nano with the Serial debugging turned on...
...
void setup()
{
  ...
  display.println("  9-axis MEMS ");
  display.setTextSize(2);
  // # of chars:  "1234567890"
  display.println("grokmotion");
  display.display();
...
void magcalMPU9250(float * dest1, float * dest2) 
{
  ...
  display.setCursor(0,0);
  // # of chars: ("12345678901234567890")
  display.println("Calibrate Mag:      ");
  display.println("Wave in a figure-8  ");
  display.println("      for 10 seconds");
  display.display();
  ...
  display.setCursor(0,0);
  // # of chars: ("12345678901234567890")
  display.println("Mag calibrated");
  display.display();
}
