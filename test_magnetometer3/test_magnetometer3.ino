...
void setup()
{
  ...
  Serial.println(Wire.requestFrom(HMC5883L_ADDR, 3));
  Serial.println(Wire.requestFrom(HMC5883L_ADDR, 4));
  Serial.println(Wire.requestFrom(HMC5883L_ADDR, A4));
  Serial.println(Wire.requestFrom(HMC5883L_ADDR, A5));
}
